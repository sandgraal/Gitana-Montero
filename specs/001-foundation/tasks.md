...
- [x] **T105 [PLATFORM]** Check scripts: `check:locales`, `check:citations`, `check:glossary` (stub until glossary exists), `check:links`, ES `usted`-register lint, `npm run verify` aggregator. Depends: T104. *(SCF-02, I18N-07, REF-02)*
